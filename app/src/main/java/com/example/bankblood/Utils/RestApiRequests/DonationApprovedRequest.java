...
public class DonationApprovedRequest extends FetchData implements Callback<HashMap> {


    int id;

    public DonationApprovedRequest(int id){
    ...
    public void start() {
        ...
        Call<HashMap>  donationApprroved= apiInterface.donationApprroved(id);
        donationApprroved.enqueue(this);
    }
