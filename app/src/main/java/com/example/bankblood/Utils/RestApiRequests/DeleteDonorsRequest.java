...
public class DeleteDonorsRequest extends FetchData implements Callback<HashMap> {


    int id;

    public DeleteDonorsRequest(int id){
    ...
    public void start() {
        ...
        Call<HashMap>  deleteDonners= apiInterface.deleteDonors(id);
