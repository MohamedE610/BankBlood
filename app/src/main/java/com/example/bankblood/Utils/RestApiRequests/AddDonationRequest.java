...
public class AddDonationRequest extends FetchData implements Callback<HashMap> {


    int id;

    public AddDonationRequest(int id){
    ...
    public void start() {
        ...
        Call<HashMap>  addDonation= apiInterface.addDonation(id);
        addDonation.enqueue(this);
    }
