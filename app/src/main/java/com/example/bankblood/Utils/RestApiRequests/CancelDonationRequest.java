...
public class CancelDonationRequest extends FetchData implements Callback<HashMap> {


    int id;

    public CancelDonationRequest(int id){
    ...
    public void start() {
        ...
        Call<HashMap>  cancelDonation= apiInterface.cancelDonation(id);
        cancelDonation.enqueue(this);
    }
